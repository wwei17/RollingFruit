...
public class GameOpeningPanel extends BasePanel{
		...
		public GameOpeningPanel(GameScene gs){
		    ...
		    text = new Text(gameScene.SCREEN_WIDTH/2, gameScene.SCREEN_HEIGHT/2+70, gameScene.resourceManager.fontTinyBlack, "Target skehgnrghiwscerhgwechgrwsngcbjrseg", new TextOptions(AutoWrap.WORDS, gameScene.SCREEN_WIDTH-250, HorizontalAlign.LEFT), gameScene.vertexBufferObjectManager);
		...
		public void setTargetText(){
			...
			for(FoodType type : gameScene.gameHUD.targetMap.keySet()){
				sb.setLength(0);
			    Text text2 = new Text(gameScene.SCREEN_WIDTH/2, gameScene.SCREEN_HEIGHT/2+110-40*i, gameScene.resourceManager.fontTinyBlack, "Target skehgnrghiwscerhgwechgrwsngcbjrseg", new TextOptions(AutoWrap.WORDS, gameScene.SCREEN_WIDTH-250, HorizontalAlign.LEFT), gameScene.vertexBufferObjectManager);
			    attachChild(text2);
