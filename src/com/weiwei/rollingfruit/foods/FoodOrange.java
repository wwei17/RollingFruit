...
public class FoodOrange extends BaseFood{

	public FoodOrange(float pX, float pY, int i, int j) {
		super(pX, pY,i, j, BaseFood.foodPanel.pScene.resourceManager.orangeTextureRegion);
		final_stage = 20;
		calories = 10;
	}
